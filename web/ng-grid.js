...
var TEMPLATE_REGEXP = /<.+>/;
window.senecaDataEditorNgGrid = {};
window.senecaDataEditorNgGrid.i18n = {};

// Declare app level module which depends on filters, and services
var senecaDataEditorNgGridServices = angular.module('senecaDataEditorNgGrid.services', []);
var senecaDataEditorNgGridDirectives = angular.module('senecaDataEditorNgGrid.directives', []);
var senecaDataEditorNgGridFilters = angular.module('senecaDataEditorNgGrid.filters', []);
// initialization of services into the main module
angular.module('senecaDataEditorNgGrid', ['senecaDataEditorNgGrid.services', 'senecaDataEditorNgGrid.directives', 'senecaDataEditorNgGrid.filters']);
...
var ngMoveSelectionHandler = function($scope, elm, evt, grid) {
    ...
    if (offset) {
        ...
        if (r.beforeSelectionChange(r, evt)) {
            ...
            $scope.$emit('senecaDataEditorNgGridEventDigestGridParent');
...
senecaDataEditorNgGridFilters.filter('checkmark', function() {
    return function(input) {
        return input ? '\u2714' : '\u2718';
    };
});
senecaDataEditorNgGridFilters.filter('ngColumns', function() {
    return function(input) {
...
angular.module('senecaDataEditorNgGrid.services').factory('$domUtilityService',['$utilityService', function($utils) {
...
angular.module('senecaDataEditorNgGrid.services').factory('$sortService', ['$parse', function($parse) {
    var sortService = {};
...
angular.module('senecaDataEditorNgGrid.services').factory('$utilityService', ['$parse', function ($parse) {
    ...
    var utils = {
        ...
        seti18n: function($scope, language) {
            var $langPack = window.senecaDataEditorNgGrid.i18n[language];
...
var senecaDataEditorNgGrid = function ($scope, options, sortService, domUtilityService, $filter, $templateCache, $utils, $timeout, $parse, $http, $q) {
    var defaults = {
    ...
    self.maxCanvasHt = 0;
    //self vars
    self.config = $.extend(defaults, window.senecaDataEditorNgGrid.config, options);
    ...
    self.setRenderedRows = function (newRows) {
        ...
        $scope.$emit('senecaDataEditorNgGridEventRows', newRows);
    };
    ...
    self.init = function() {
        return self.initTemplates().then(function(){
            ...
            $scope.$watch('configGroups', function(a) {
              ...
              $scope.$emit('senecaDataEditorNgGridEventGroups', a);
            }, true);
            $scope.$watch('columns', function (a) {
                domUtilityService.BuildStyles($scope, self, true);
                $scope.$emit('senecaDataEditorNgGridEventColumns', a);
            }, true);
            $scope.$watch(function() {
                return options.i18n;
            }, function(newLang) {
    ...
    self.sortData = function(col, evt) {
        ...
        $scope.$emit('senecaDataEditorNgGridEventSorted', self.config.sortInfo);
    };
  ...
  $scope.HOWDY=true
    ...
    $scope.adjustScrollTop = function(scrollTop, force) {
        ...
        if (scrollTop > 0 && self.$viewport[0].scrollHeight - scrollTop <= self.$viewport.outerHeight()) {
            $scope.$emit('senecaDataEditorNgGridEventScroll');
        }
...
var ngSearchProvider = function ($scope, grid, $filter) {
    ...
    $scope.$watch('filterText', function(a){
        if (!self.extFilter) {
            $scope.$emit('senecaDataEditorNgGridEventFilter', a);
...
senecaDataEditorNgGridDirectives.directive('ngCellHasFocus', ['$domUtilityService',
...
senecaDataEditorNgGridDirectives.directive('ngCellText',
  function () {
      return function(scope, elm) {
...
senecaDataEditorNgGridDirectives.directive('ngCell', ['$compile', '$domUtilityService', function ($compile, domUtilityService) {
    var ngCell = {
        scope: false,
        compile: function() {
            return {
                ...
                post: function($scope, iElement) {
                    ...
                    $scope.$on('senecaDataEditorNgGridEventDigestCell', function() {
                        domUtilityService.digest($scope);
                    });
                }
            };
...
senecaDataEditorNgGridDirectives.directive('senecaDataEditorNgGridFooter', ['$compile', '$templateCache', function ($compile, $templateCache) {
    var senecaDataEditorNgGridFooter = {
        scope: false,
        compile: function () {
            return {
                pre: function ($scope, iElement) {
    ...
    return senecaDataEditorNgGridFooter;
}]);
senecaDataEditorNgGridDirectives.directive('senecaDataEditorNgGridMenu', ['$compile', '$templateCache', function ($compile, $templateCache) {
    var senecaDataEditorNgGridMenu = {
        scope: false,
        compile: function () {
            return {
                pre: function ($scope, iElement) {
    ...
    return senecaDataEditorNgGridMenu;
}]);
senecaDataEditorNgGridDirectives.directive('senecaDataEditorNgGrid', ['$compile', '$filter', '$templateCache', '$sortService', '$domUtilityService', '$utilityService', '$timeout', '$parse', '$http', '$q', function ($compile, $filter, $templateCache, sortService, domUtilityService, $utils, $timeout, $parse, $http, $q) {
    var senecaDataEditorNgGridDirective = {
        scope: true,
        compile: function() {
            return {
                pre: function($scope, iElement, iAttrs) {
                    var $element = $(iElement);
                    var options = $scope.$eval(iAttrs.senecaDataEditorNgGrid);
                    options.gridDim = new ngDimension({ outerHeight: $($element).height(), outerWidth: $($element).width() });

                    var grid = new senecaDataEditorNgGrid($scope, options, sortService, domUtilityService, $filter, $templateCache, $utils, $timeout, $parse, $http, $q);
                    return grid.init().then(function() {
                        ...
                        if (typeof options.data === "string") {
                            var dataWatcher = function (a) {
                                ...
                                if (grid.config.sortInfo.fields.length > 0) {
                                    ...
                                    grid.sortActual();
                                    grid.searchProvider.evalFilter();
                                    $scope.$emit('senecaDataEditorNgGridEventSorted', grid.config.sortInfo);
                                }
                                $scope.$emit("senecaDataEditorNgGridEventData", grid.gridId);
                            };
                        ...
                        iElement.addClass("senecaDataEditorNgGrid").addClass(grid.gridId.toString());
                        ...
                        options.senecaDataEditorNgGrid = grid;
                        ...
                        $scope.$on('senecaDataEditorNgGridEventDigestGrid', function(){
                            domUtilityService.digest($scope.$parent);
                        });         
                        
                        $scope.$on('senecaDataEditorNgGridEventDigestGridParent', function(){
                            domUtilityService.digest($scope.$parent);
                        });
                        // set up the columns 
                        $scope.$evalAsync(function() {
    ...
    return senecaDataEditorNgGridDirective;
}]);
senecaDataEditorNgGridDirectives.directive('ngHeaderCell', ['$compile', function($compile) {
    var ngHeaderCell = {
        scope: false,
        compile: function() {
            return {
...
senecaDataEditorNgGridDirectives.directive('senecaDataEditorNgIf', [function () {
  return {
    transclude: 'element',
    priority: 1000,
    terminal: true,
    ...
    compile: function (e, a, transclude) {
      return function (scope, element, attr) {
        ...
        scope.$watch(attr['senecaDataEditorNgIf'], function (newValue) {
          if (childElement) {
            childElement.remove();
...
senecaDataEditorNgGridDirectives.directive('ngInput', [function() {
    return {
        require: 'ngModel',
...
senecaDataEditorNgGridDirectives.directive('ngRow', ['$compile', '$domUtilityService', '$templateCache', function ($compile, domUtilityService, $templateCache) {
    var ngRow = {
        scope: false,
        compile: function() {
            return {
                pre: function($scope, iElement) {
					...
					$scope.$on('senecaDataEditorNgGridEventDigestRow', function(){
						domUtilityService.digest($scope);
					});
                }
            };
...
senecaDataEditorNgGridDirectives.directive('ngViewport', [function() {
    return function($scope, elm) {
...
window.senecaDataEditorNgGrid.i18n['de'] = {
...
window.senecaDataEditorNgGrid.i18n['en'] = {
...
window.senecaDataEditorNgGrid.i18n['fr'] = {
...
window.senecaDataEditorNgGrid.i18n['pt-br'] = {
    ngAggregateLabel: 'items',
...
window.senecaDataEditorNgGrid.i18n['sp'] = {
...
window.senecaDataEditorNgGrid.i18n['zh-cn'] = {
    ngAggregateLabel: '条目',
...
window.senecaDataEditorNgGrid.i18n['zh-tw'] = {
    ngAggregateLabel: '筆',
...
angular.module("senecaDataEditorNgGrid").run(["$templateCache", function($templateCache) {
  ...
  $templateCache.put("cellEditTemplate.html",
    ...
    "	<div senecaDataEditorNgIf=\"!isFocused\">" +
  ...
  $templateCache.put("gridTemplate.html",
    ...
    "    </div>" +
    "    <div seneca-data-editor-ng-grid-menu></div>" +
    "</div>" +
    ...
    "    </div>" +
    "</div>" +
    "<div seneca-data-editor-ng-grid-footer></div>" +
    ""
  );
